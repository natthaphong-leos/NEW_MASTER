...
#Region "INITIALIZATION"
    Public Sub LoadForm()
        ...
        AddHandler Me.Paint, AddressOf Form2_Paint
        AddHandler Me.MouseDown, AddressOf Form2_MouseDown
        AddHandler Me.MouseMove, AddressOf Form2_MouseMove
        ' AddHandler Me.MouseUp, AddressOf Form2_MouseUp
        '======================= END =======================
...
#End Region
#Region "FORM EVENT"
    Private Sub frm_Page_2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        Try
    ...
    Private Sub frm_Page_2_Shown(sender As Object, e As EventArgs) Handles Me.Shown
        '============ For Test IO
        If Mode_Test_IO = True Then
...
#Region "DRAW LINE" '======== ADD BY APICHAT FOR DRAW LINE
    ...
    Private Sub Form2_MouseMove(sender As Object, e As MouseEventArgs)
